...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $barang->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Barangs", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/barangs/'.$barang->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Barangs", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.barangs.destroy', $barang->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/barangs') }}" data-toggle="tooltip" data-placement="right" title="Back to Barangs"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'nama_barang')
						@la_display($module, 'harga_barang')
						@la_display($module, 'id_cat')
						@la_display($module, 'id_kayu')
						@la_display($module, 'id_kategori')
					</div>
				</div>
			</div>
		</div>
