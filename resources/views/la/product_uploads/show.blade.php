...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $product_upload->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Product_uploads", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/product_uploads/'.$product_upload->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Product_uploads", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.product_uploads.destroy', $product_upload->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/product_uploads') }}" data-toggle="tooltip" data-placement="right" title="Back to Product uploads"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'Nama Produk')
						@la_display($module, 'Jenis Produk')
						@la_display($module, 'Harga Produk')
						@la_display($module, 'Gambar Produk')
					</div>
				</div>
			</div>
		</div>
