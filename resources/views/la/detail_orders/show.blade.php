...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		<div class="col-md-4">
			<div class="row">
				...
				<div class="col-md-9">
					<h4 class="name">{{ $detail_order->$view_col }}</h4>
					<div class="row stats">
		...
		<div class="col-md-1 actions">
			@la_access("Detail_Orders", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/detail_orders/'.$detail_order->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Detail_Orders", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.detail_orders.destroy', $detail_order->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/detail_orders') }}" data-toggle="tooltip" data-placement="right" title="Back to Detail Orders"><i class="fa fa-chevron-left"></i></a></li>
			...
			<div class="tab-content">
				<div class="panel infolist">
					...
					<div class="panel-body">
						@la_display($module, 'jumlah_barang')
						@la_display($module, 'harga_barang')
						@la_display($module, 'id_barang')
						@la_display($module, 'id_order')
					</div>
				</div>
			</div>
		</div>
