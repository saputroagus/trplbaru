...
<div id="page-content" class="profile2">
	<div class="bg-primary clearfix">
		...
		<div class="col-md-1 actions">
			@la_access("Cats", "edit")
				<a href="{{ url(config('laraadmin.adminRoute') . '/cats/'.$cat->id.'/edit') }}" class="btn btn-xs btn-edit btn-default"><i class="fa fa-pencil"></i></a><br>
			@endla_access
			
			@la_access("Cats", "delete")
				{{ Form::open(['route' => [config('laraadmin.adminRoute') . '.cats.destroy', $cat->id], 'method' => 'delete', 'style'=>'display:inline']) }}
	...
	<ul data-toggle="ajax-tab" class="nav nav-tabs profile" role="tablist">
		<li class=""><a href="{{ url(config('laraadmin.adminRoute') . '/cats') }}" data-toggle="tooltip" data-placement="right" title="Back to Cats"><i class="fa fa-chevron-left"></i></a></li>
